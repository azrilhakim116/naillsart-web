...
<section class="max-w-[1200px] mx-auto px-6 py-12">
	...
	<div class="grid md:grid-cols-2 gap-8 mb-12">
		...
		<div class="space-y-6">
			...
			<div>
				<h3 class="font-[Kalnia] text-xl text-[#7A2E2E] mb-3">Features:</h3>
				<ul class="space-y-2 text-gray-700">
					<li>✨ Premium quality materials</li>
					<li>✨ Easy to apply and remove</li>
					<li>✨ Reusable and durable</li>
					<li>✨ Perfect fit for all nail sizes</li>
					<li>✨ Includes application kit</li>
				</ul>
			</div>
			...
			<div class="pt-6">
				<a href="https://s.shopee.co.id/6fd78uVutN?share_channel_code=1" 
				   target="_blank"
				   class="inline-block px-8 py-4 bg-[#D89C9B] text-white font-[Kalnia] tracking-wider rounded-full hover:bg-[#CE8A97] transition">
					ORDER NOW ON SHOPEE
				</a>
			</div>
		</div>
	...
	<div class="max-w-[1440px] mx-auto px-6">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
			<div class="flex justify-center md:justify-start">
				<img src="../public/images/onnailss.png" alt="ONNAILS Logo" class="h-32 object-contain">
			</div>
			<div class="text-center md:text-left">
				<h3 class="font-[Kalnia] text-xl text-[#6B3A3A] mb-4">BOOKING</h3>
				<div class="space-y-3 font-[Kalnia]">
					<a href="https://wa.me/62895433711020" target="_blank" class="block hover:text-[#CE8A97]">
						<i class="fa-brands fa-whatsapp"></i> WhatsApp
					</a>
					<a href="https://s.shopee.co.id/6fd78uVutN?share_channel_code=1" target="_blank" class="block hover:text-[#CE8A97]">
						Shopee
					</a>
				</div>
			</div>
			<div class="text-center md:text-left">
				<h3 class="font-[Kalnia] text-xl text-[#6B3A3A] mb-4">SOCIAL MEDIA</h3>
				<div class="space-y-3 font-[Kalnia]">
					<a href="https://www.instagram.com/onnailssss" target="_blank" class="block hover:text-[#CE8A97]">
						<i class="fa-brands fa-instagram"></i> Instagram
					</a>
					<a href="https://www.tiktok.com/@onnailsss_?_r=1&_t=ZS-95HjEZLRVMg" target="_blank" class="block hover:text-[#CE8A97]">
